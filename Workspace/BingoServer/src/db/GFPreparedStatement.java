...
public class GFPreparedStatement extends GFStatement implements PreparedStatement
{
    protected PreparedStatement comando=null;

    public GFPreparedStatement (String drv,
                                 String strCon,
                                 String usr,
                                 String senha)
    ...
    public ResultSet executeQuery () throws SQLException
    {
        ...
        GFResultSet retorno = new GFResultSet(this.comando, resultado);
    ...
    public boolean equals (Object obj)
    {
        ...
        {
			GFPreparedStatement ps = (GFPreparedStatement)obj;

			if (!super.equals(ps))
			    return false;

            GFPreparedStatement mps = (GFPreparedStatement)obj;
