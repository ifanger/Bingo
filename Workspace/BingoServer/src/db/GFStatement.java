...
public class GFStatement implements Statement
{
    ...
    protected ArrayList<GFResultSet> resultados =
              new ArrayList<GFResultSet> ();

    public GFStatement (String drv,
                         String strCon,
                         String usr,
                         String senha)
    ...
    public boolean equals (Object obj)
    {
        ...
        if (this.getClass()==obj.getClass())
        {
            ...
            GFPreparedStatement ms = (GFPreparedStatement)obj;
